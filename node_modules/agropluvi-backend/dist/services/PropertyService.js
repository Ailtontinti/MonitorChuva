...
function toGeoPointArray(value) {
...
function normalizePropertyMetadata(metadata) {
    if (!metadata || typeof metadata !== 'object')
        return metadata ?? null;
    const polygonFromGeoJson = (value) => {
...
class PropertyService {
    constructor(propertyRepository = new PropertyRepository_1.PropertyRepository()) {
